...
export default function VerificaCorreo() {
    ...
    useEffect(() => {
        ...
        if (user.verificacion_email) {
            navigate('/Dashboard/perfil/General', { replace: true })
        }
    }, [user, navigate])
        ...
        try {
            ...
            if (updated) {
                ...
                if (updated.verificacion_email) {
                    navigate('/Dashboard/perfil/General?verified=1', { replace: true })
                    return
                }
            }
            ...
            <div className="w-full max-w-md bg-white rounded-4xl shadow-2xl overflow-hidden border border-gray-300 relative z-10">
                ...
                <div className="relative z-20 p-6 flex flex-col items-center text-center gap-4">
                    ...
                    <p className="text-xs text-gray-500! text-center leading-relaxed">
                        Haz clic en el enlace del correo para activar tu cuenta. Si no lo encuentras, revisa la carpeta de spam.
                    </p>
